        ...
        <div className="container py-20 md:py-28 grid items-center gap-10 md:grid-cols-2">
          <div className="space-y-6">
            ...
            <p className="text-lg text-muted-foreground max-w-xl">
              Real‑time protection for visitors using AI anomaly detection,
              blockchain‑backed digital IDs, and geo‑fencing alerts. Built for
              rapid response in remote and high‑risk regions.
            </p>
            ...
            <div className="flex flex-wrap gap-4 text-sm text-muted-foreground">
              <div className="flex items-center gap-2">
                <ScanEye className="size-4" /> Anomaly detection
              </div>
              <div className="flex items-center gap-2">
                <MapPin className="size-4" /> Geo‑fencing
              </div>
              <div className="flex items-center gap-2">
                <Lock className="size-4" /> E2E encryption
              </div>
              <div className="flex items-center gap-2">
                <Languages className="size-4" /> 10+ languages
              </div>
            </div>
          </div>
                    ...
                    <Card>
                      <CardContent className="pt-6 space-y-2">
                        <div className="flex items-center gap-2 text-sm font-medium">
                          <Route className="size-4" /> Route deviation
                        </div>
                        <p className="text-xs text-muted-foreground">
                          Instant alerts on off‑itinerary movement.
                        </p>
                      </CardContent>
                    </Card>
                    <Card>
                      <CardContent className="pt-6 space-y-2">
                        <div className="flex items-center gap-2 text-sm font-medium">
                          <MapPin className="size-4" /> Geo‑fence alert
                        </div>
                        <p className="text-xs text-muted-foreground">
                          Warns on entry to high‑risk zones.
                        </p>
                      </CardContent>
                    </Card>
                      ...
                      <CardContent className="pt-6 flex items-center justify-between">
                        <div>
                          <div className="text-sm font-medium flex items-center gap-2">
                            <Siren className="size-4" /> Panic Button
                          </div>
                          <p className="text-xs text-muted-foreground">
                            Shares live location with nearest police & contacts.
                          </p>
                        </div>
      ...
      <section className="container py-16 md:py-24">
        <div className="mx-auto max-w-3xl text-center">
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight">
            A secure, multilingual safety ecosystem
          </h2>
          <p className="mt-3 text-muted-foreground">
            Web portal and mobile app for tourists and authorities, backed by
            AI/ML and tamper‑proof blockchain records.
          </p>
        </div>
        <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          <Feature
            ...
            desc="Issue time‑bound tourist IDs with KYC, itinerary and emergency contacts on blockchain."
          />
          <Feature
            icon={<Bot className="size-5" />}
            title="AI Anomaly Detection"
            desc="Detect drop‑offs, inactivity or distress patterns; trigger predictive alerts."
          />
          <Feature
            icon={<MapPin className="size-5" />}
            title="Geo‑fencing"
            desc="Real‑time alerts when entering restricted or high‑risk zones."
          />
          <Feature
            icon={<Siren className="size-5" />}
            title="Panic & Live Location"
            desc="One‑tap SOS to nearest police unit and emergency contacts."
          />
          <Feature
            icon={<Satellite className="size-5" />}
            title="IoT Wearables"
            desc="Optional smart bands for vitals and location in caves, forests or remote trails."
          />
          <Feature
            icon={<Languages className="size-5" />}
            title="Multilingual Access"
            desc="10+ Indian languages with voice/text emergency support."
          />
        </div>
      </section>
        ...
        <div className="container py-16 md:py-24 grid gap-8 lg:grid-cols-2 items-center">
          <div className="space-y-4">
            <h3 className="text-2xl md:text-3xl font-bold tracking-tight">
              Tourism & Police Dashboard
            </h3>
            <ul className="space-y-2 text-muted-foreground">
              <li className="flex items-center gap-2">
                <MapPin className="size-4" /> Live heat maps of clusters &
                high‑risk zones
              </li>
              <li className="flex items-center gap-2">
                <Activity className="size-4" /> Alert history, last known
                locations, E‑FIR generation
              </li>
              <li className="flex items-center gap-2">
                <Lock className="size-4" /> Privacy‑first with end‑to‑end
                encryption
              </li>
            </ul>
        ...
        <div className="grid gap-8 md:grid-cols-2 items-center">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">
              End‑to‑end encryption ensures only authorized parties can access
              data. Blockchain provides tamper‑proof identity and travel
              records, valid only for the visit duration.
            </p>
            <div className="flex gap-3">
              ...
              <Button asChild>
                <Link to="/digital-id">Issue Digital ID</Link>
              </Button>
            </div>
          </div>
